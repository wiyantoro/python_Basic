...
e= Entry(root, width=35,bg='#ffc400', borderwidth=5)
...
button_clear=Button(root, text="clear", padx=79, pady=20,bg='#ffc400', command=button_clear)
...
button_clear.grid(row=1, column=4, columnspan=2)
